    ...
    <div class="container">
        <div class="row">
            ...
            <div class="f3">
                ...
                <div class="media-v1">
                    <img src="<?= $this->user->image_path ? $this->user->image_path : URL . '/img/default-user.png' ?>">
                </div>
                ...
                <div class="container">
                    <div class="row">
                     <div class="f3">
                        ...
                        <a href="<?= URL ?>/user/image" id="myBtn" type="button" class="btn btn-black">Change Profile picture</a>
                    </div>
